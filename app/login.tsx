...
interface LoginResponse {
  token?: string;
  user?: { role: string | null; [key: string]: any };
...
<TouchableOpacity onPress={() => router.push("/ngo-signup")} style={styles.link} disabled={loading}>
  <Text style={styles.linkText}>Register your <Text style={{ textDecorationLine: 'underline' }}>NGO</Text> </Text>
</TouchableOpacity>
    </View>
  );
}
...
const styles = StyleSheet.create({
  ...
  input: { borderWidth: 1, borderColor: "#2D9E7A", paddingHorizontal: 12, paddingVertical: 10, borderRadius: 8, marginBottom: 12, backgroundColor: "#fff", color: "#0F2141" },
